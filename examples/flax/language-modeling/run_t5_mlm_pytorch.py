...
if __name__ == "__main__":
    ...
    if model_args.model_name_or_path:
        model = T5ForConditionalGeneration.from_pretrained(
            model_args.model_name_or_path, config=config, seed=training_args.seed, torch_dtype="auto"
        )
    else:
        model = T5ForConditionalGeneration(config, seed=training_args.seed, torch_dtype="auto")
    ...
    train_batch_size = int(training_args.per_device_train_batch_size) * dist.get_world_size()
    eval_batch_size = int(training_args.per_device_eval_batch_size) * dist.get_world_size()
